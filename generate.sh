...
dotnet new webapi -au IndividualB2C -f net7.0 -n $company.$project.WebAPI -o $company.$project.WebAPI
...
dotnet new classlib -f net7.0 -n $company.$project.Application -o $company.$project.Application 
dotnet sln add $company.$project.Application
mkdir $company.$project.Application/Services

dotnet new classlib -f net7.0 -n $company.$project.Domain -o $company.$project.Domain 
...
dotnet new classlib -f net7.0 -n $company.$project.Infrastructure -o $company.$project.Infrastructure 
...
dotnet new classlib -f net7.0 -n $company.$project.Repository -o $company.$project.Repository 
...
dotnet new xunit -f net7.0 -n $company.$project.Tests -o $company.$project.Tests 
